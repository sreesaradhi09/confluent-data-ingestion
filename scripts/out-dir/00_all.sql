...
-- >>> QUARANTINE_CBA_CI_ADR_REF
CREATE TABLE IF NOT EXISTS `QUARANTINE_CBA_CI_ADR_REF` (
  CI_ID INT,
  ADR_ID INT,
  CITY STRING,
  PRIMARY KEY (CI_ID) NOT ENFORCED
...
-- >>> QUARANTINE_CBA_CI_ADR_REF
INSERT INTO `QUARANTINE_CBA_CI_ADR_REF` (CI_ID, ADR_ID, CITY)
SELECT
  a.CI_ID AS CI_ID,
  a.ADR_ID AS ADR_ID,
  a.CITY AS CITY
